    ...
    public function run(): void
    {
        ...
        $goals = [
            ...
            [
                ...
                'user_id'        => $user1,
                'parent_goal_id' => '11111111-aaaa-4000-8000-000000000001',
            ...
            [
                ...
                'user_id'        => $user1,
                'parent_goal_id' => '11111111-aaaa-4000-8000-000000000002',
            ...
            [
                ...
                'user_id'        => $user1,
                'parent_goal_id' => '11111111-aaaa-4000-8000-000000000003',
            ...
            [
                ...
                'user_id'        => $user1,
                'parent_goal_id' => '11111111-aaaa-4000-8000-000000000004',
            ...
            [
                ...
                'user_id'        => $user1,
                'parent_goal_id' => '11111111-aaaa-4000-8000-000000000005',
            ...
            [
                ...
                'user_id'        => $user1,
                'parent_goal_id' => '11111111-aaaa-4000-8000-000000000006',
            ...
            [
                ...
                'user_id'        => $user2,
                'parent_goal_id' => '22222222-bbbb-4000-8000-000000000001',
                'title'          => '体重を10kg減らす',
            ...
            [
                ...
                'user_id'        => $user2,
                'parent_goal_id' => '22222222-bbbb-4000-8000-000000000002',
                'title'          => '今年中に5kg減らす',
            ...
            [
                ...
                'user_id'        => $user2,
                'parent_goal_id' => '22222222-bbbb-4000-8000-000000000003',
            ...
            [
                'id'             => '33333333-cccc-4000-8000-000000000002',
                'user_id'        => $user3,
                'parent_goal_id' => '33333333-cccc-4000-8000-000000000001',
